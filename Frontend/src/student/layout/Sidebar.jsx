...
const Sidebar = ({ isSidebarOpen, toggleSidebar }) => {
  const menuItems = [
    ...
    {name:"plans", path:"/student/plans", icon:<FaRocket />},
    { name: "Students", path: "/student/students", icon: <FaUserShield /> },
    {name:"View Students", path:"/student/view-students", icon:<FaUserShield />},
    { name: "Teachers", path: "/student/teachers", icon: <FaUserShield /> },
    {name:"View Teachers", path:"/student/view-teachers", icon:<FaUserShield />},
